...
```{r}
elec<-ts(data[1:4507,2],start=c(1,1),freq=4)
elecTemperature=ts(data[1:4507,2:3],start=c(1,5),freq=4)
elec
```

```{r}
elec_train = window(elec, start=c(1,1), end=c(46,96))
...
```{r}
fit900=Arima(elec, order=c(9,0,0), seasonal=c(0,1,3))
checkresiduals(fit900)
